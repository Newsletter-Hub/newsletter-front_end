            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">December 27, 2023</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: 'rgb(127, 127, 127)' }}>
            <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Newsletter Hub</bdt> ("
          ...
          <span style={{ color: 'rgb(127, 127, 127)' }}>
            <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Newsletter Hub</bdt>) are called
                  ...
                  >
                    ...
                    <td style={{ display: 'inline-block', marginLeft: 5 }}>
                      <span
                        style={{ color: '#8b93a7', wordBreak: 'break-all' }}
                      >
                        Authenticate users for actions on website
                      </span>
                    </td>
                  </tr>
                  <tr
                  ...
                  >
                    ...
                    <td style={{ display: 'inline-block', marginLeft: 5 }}>
                      ...
                      >
                        Newsletter Hub{' '}
                        <a
                          href="https://www.newsletterhub.co/privacy"
                      ...
                      >
                        ...
                        <td style={{ display: 'inline-block', marginLeft: 5 }}>
                          <span
                            style={{ color: '#8b93a7', wordBreak: 'break-all' }}
                          >
                            Used to measure the conversion rate of ads presented
                            to the user. Expires in 1.5 years.
                          </span>
                        </td>
                      </tr>
                      <tr
            ...
            <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">privacy@newsletterhub.co</bdt> or by
                  post to
